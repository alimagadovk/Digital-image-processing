...
plot(bpp5, PSNR5, '*r', 'LineWidth', 1.5)
p5 = plot(bpp5, PSNR5, 'r', 'LineWidth', 1.5, 'DisplayName', 'PSNR(bpp), task5');
xlabel('bpp')
ylabel('PSNR')
title('PSNR(bpp)')
legend([p1, p5], 'Location', 'northwest')
%%
% fileID = fopen('bpp51_task7.txt','w');
% fprintf(fileID,'%.16f\n',bpp5);
% fclose(fileID);
% fileID = fopen('PSNR51_task7.txt','w');
% fprintf(fileID,'%.16f\n',PSNR5);
% fclose(fileID);


% fileID = fopen('SSIM51_task7.txt','w');
% fprintf(fileID,'%.16f\n',SSIM5);
% fclose(fileID);
%%
...
bpp5 = fscanf(fileID,'%f\n');
fclose(fileID);
fileID = fopen('PSNR51_task7.txt','r');
PSNR5 = fscanf(fileID,'%f\n');
fclose(fileID);